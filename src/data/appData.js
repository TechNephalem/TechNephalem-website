export const appData = {
    ...
    "services": [
        {
            ...
            "features": ["Machine Learning Models", "Natural Language Processing", "Computer Vision", "Predictive Analytics","Large Language Models", "AI Agents"],
            "icon": "brain",
            "color": "#6366f1"
        },
        {
        ...
        },
        {
            ...
            "description": "Full-stack web applications using MongoDB, SQL, Express.js, React, Node.js, GoLang and Python for robust digital experiences.",
            "features": ["Frontend", "Backend", "Database", "RESTful APIs","GraphQL" ,"Real-time communications","Payment Integrations"],
            "icon": "layers",
            "color": "#ef4444"
        }
    ],
    ...
    "contact": {
        ...
        "instagram":"https://www.instagram.com/technephalem"
    }
};